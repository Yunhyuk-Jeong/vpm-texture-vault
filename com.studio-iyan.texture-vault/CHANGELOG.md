...
- Added Standalone BC7 / Max Size 4096 import profile application.
- Added snapshot-based Texture Import Settings restore.
- Added VPM package metadata, release workflow, and GitHub Pages listing workflow.
